 ...
 * @property int $type 
 */
class BasNuclearInside extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'bas_nuclear_inside';
    /**
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'nuclear_id' => 'integer', 'vessel_id' => 'integer', 'shell_id' => 'integer', 'type' => 'integer'];
}