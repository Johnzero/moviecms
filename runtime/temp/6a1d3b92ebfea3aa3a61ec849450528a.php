<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/wwwroot/dyzb111.xyz/application/admin/view/art/index.html";i:1622161391;s:64:"/www/wwwroot/dyzb111.xyz/application/admin/view/public/head.html";i:1622161391;s:64:"/www/wwwroot/dyzb111.xyz/application/admin/view/public/foot.html";i:1622161391;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>[<?php echo $vo['type']['type_name']; ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_art_detail($vo); ?>"><?php echo htmlspecialchars($vo['art_name']); ?></a> <?php if($vo['art_status'] == 0): ?> <span class="layui-badge"><?php echo lang('reviewed_not'); ?></span><?php endif; if($vo['art_lock'] == 1): ?> <span class="layui-badge"><?php echo lang('lock'); ?></span><?php endif; ?></td>
